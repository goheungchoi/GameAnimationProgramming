...
AssimpSettingsContainer::AssimpSettingsContainer(
...
void AssimpSettingsContainer::apply(std::shared_ptr<AssimpInstance> instance,
																		InstanceSettings newSettings,
																		InstanceSettings oldSettings) {
	...
	std::stack<AssimpInstanceSettings> emptyStack;
...
int AssimpSettingsContainer::getUndoSize() { return mUndoStack.size(); }

int AssimpSettingsContainer::getRedoSize() { return mRedoStack.size(); }
