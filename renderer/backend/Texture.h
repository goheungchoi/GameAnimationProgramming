...
class Texture {
 public:
  static bool loadTexture(VkRenderData &renderData, VkTextureData &texData,
                          std::string textureFilename,
                          bool generateMipmaps = true, bool flipImage = false);
  static bool loadTexture(VkRenderData &renderData, VkTextureData &texData,
                          std::string textureName, aiTexel *textureData,
 ...
 private:
  static bool uploadToGPU(VkRenderData &renderData, VkTextureData &texData,
