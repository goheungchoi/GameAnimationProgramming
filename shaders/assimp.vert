...
layout (std140, set = 1, binding = 1) readonly restrict buffer WorldPosMatrices {
	mat4 worldPosMat[];
};

void main() {
	mat4 model = worldPosMat[gl_InstanceIndex + worldPosMatIndexOffset];
